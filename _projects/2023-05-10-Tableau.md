...
list_description: Built two interactive Tableau dashboards a primary sales model analyzing $21M+ in revenue to track customer demographics, profit trends, and product performance, and a supplemental Netflix content trend analyzer. Demonstrated end-to-end business intelligence capabilities by transforming complex data into actionable visual insights across commercial and media analytics.
